 ...
 * @method string csrf()
 * @method string kart()
 * @method string licenses_activate(?string $license_key = null)
 * @method string licenses_deactivate(?string $license_key = null)
 * @method string licenses_validate(?string $license_key = null)
